...
const PRODUCTS = [
  ...
  // ── Novos produtos — lote de setembro 2026 (cadastro via formulário) ──
  {
    id: 'lip-gloss-wb-beuty',
    name: 'Lip Gloss',
    brand: 'WB Beuty',
    category: 'maquiagem',
    price: 12.00,
    description: 'Lip gloss hidratante para os lábios, marca WB Beuty. Vem com chaveiro temático.',
    image: 'assets/img/products/lip-gloss-wb-beuty.png',
  },
  {
    id: 'escova-cabelo-pink-sweet',
    name: 'Escova de cabelo',
    brand: 'Pink Sweet',
    category: 'cabelo',
    price: 22.00,
    description: 'Escova de cabelo Pink Sweet, raquete com cerdas e pinos de massagem.',
    image: 'assets/img/products/escova-cabelo-pink-sweet.png',
  },
  {
    id: 'lip-gloss-chameleon',
    name: 'Lip Gloss Chameleon',
    brand: "Sarah's Beauty",
    category: 'maquiagem',
    price: 12.00,
    description: "Lip gloss Chameleon, da Sarah's Beauty, com glitter e efeito camaleão. Consulte as cores disponíveis pelo WhatsApp.",
    image: 'assets/img/products/lip-gloss-chameleon.png',
  },
  {
    id: 'popfruit-amor-anjo',
    name: 'PopFruit',
    brand: 'Amor Anjo',
    category: 'maquiagem',
    price: 40.00,
    description: 'Kit PopFruit da Amor Anjo: brilho labial em quatro versões — lip gloss, lip oil e lip gloss ice — cada uma em formato de chaveiro de fruta.',
    image: 'assets/img/products/popfruit-amor-anjo.png',
  },
  {
    id: 'lipgloss-aozy-sweet-honey',
    name: 'Lip Gloss Sweet Honey',
    brand: 'Aozy',
    category: 'maquiagem',
    price: 12.00,
